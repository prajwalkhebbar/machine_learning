...
def k_nearest_neighbour(data,predict,k=3):
    ...
    for group in data:
        for features in data[group]:
            ...
            #we use the first one since np arrays is c optimized library and is faster than the
            #conventional method
            distance.append([euclidean_distance,group])
    #gives me the lists of group name of the sorted array
    votes=[i[1] for i in sorted(distance)[:k]]
     # Without doing the [0][0] part, you get [('r', 3)]
